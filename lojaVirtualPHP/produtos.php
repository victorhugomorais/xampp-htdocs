           ...
           for ($i=0; $i < count($res); $i++) { 
            ...
            <div class="col-lg-4">
              <div class="product__discount__item">
                ...
                <div>
                <a href="produto-<?php echo $nome_url ?>"> <figure class="block-4-image text-center border">
                ...
                <ul class="product__item__pic__hover">
                 <li><a href="produto-<?php echo $nome_url ?>">
  ...
  <?php }else{ ?>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
      <div class="product__item">
        ...
        <div>
                        <figure class="block-4-image text-center border">
                    <img src="img/produtos/<?php echo $imagem ?>" alt="Image placeholder" class="img-fluid">
                    <ul class="product__item__pic__hover">
            <li><a href="produto-<?php echo $nome_url ?>"><i class="fa fa-eye"></i></a></li>
     ...
     for ($i=0; $i < count($res); $i++) { 
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="product__item">
          ...
          <div>
          <a href="combo-<?php echo $nome_url ?>">   <figure class="block-4-image text-center border">
                    <img src="img/combos/<?php echo $imagem ?>" alt="Image placeholder" class="img-fluid">
                    <i class="fa fa-eye">
                    <a href="" onclick="carrinhoModal('<?php echo $id ?>','Sim')">< class="fa fa-shopping-cart"></a>
                  </figure></a>
