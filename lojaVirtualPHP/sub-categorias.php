               ...
               for ($i=0; $i < count($res); $i++) { 
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div>
                        <a href="produtos-<?php echo $nome_url ?>"> <figure class="block-4-image text-center border">
                    <img src="img/sub-categorias/<?php echo $imagem ?>" alt="Image placeholder" class="img-fluid">
                    <i class="fa fa-eye"></i>
                </figure></a>
